...
const TABS: {key: AttemptKey; label: string; description: string}[] = [
    {key: 'action1', label: 'Design 1', description: 'Try any different object'},
    {key: 'action2', label: 'Design 2', description: 'Try any different object'},
    {key: 'action3', label: 'Design 3', description: 'Try any different object'},
];
            ...
            <View style={[localThemed.header_container, localStyles.header]}>
                ...
                <View style={localStyles.header_title_container}>
                    ...
                    <Text style={[themed.text, localStyles.header_subtitle]}>
                        Sound Pollution Hunter Challenge
                    </Text>
                </View>
                    ...
                    <View style={localStyles.input_container}>
                        ...
                        <View style={localStyles.input_row}>
                            <TextInput 
                                ...
                                placeholderTextColor='#969696'
                                keyboardType='decimal-pad'
                                value={current.loudness}
                                onChangeText={(val) => updateField('loudness', val)}>
                            </TextInput>
